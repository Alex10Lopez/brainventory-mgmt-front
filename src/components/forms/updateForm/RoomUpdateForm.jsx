        ...
        >
          ...
          >
            ...
            <Form.Control
              ...
              defaultValue={roomData.capacityMax || ""}
        ...
        >
          ...
          >
            ...
            <Form.Select
              ...
              defaultValue={roomData.building?.id || ""}
            >
              <option disabled value="">
                {isPendingBuilding
                  ? "Cargando edificios..."
        ...
        >
          ...
          >
            ...
            <Form.Select
              ...
              defaultValue={roomData.departments?.[0]?.id?.toString() || ""}
            >
              <option disabled value="">
                {isPendingDepartment
              ...
              {!isPendingDepartment &&
                !isErrorDepartment &&
                departmentReferences.data?.map((departments) => (
                  <option key={departments.id} value={departments.id}>
                    {departments.name}
                  </option>
                ))}
            </Form.Select>
            {errors.departments?.[0]?.id && (
              <Alert key="danger" variant="danger" className="mt-2 p-2">
                {errors.departments[0].id.message}
              </Alert>
            )}
            {isErrorDepartment && (
              <Alert key="warning" variant="warning" className="mt-2 p-2">
          ...
          >
            ...
            <Form.Select
              ...
              defaultValue={roomData.departments?.[1]?.id?.toString() || ""}
            >
              <option disabled value="">
                {isPendingDepartment
                  ? "Cargando departamentos / áreas..."
